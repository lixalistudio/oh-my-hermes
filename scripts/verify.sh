...
check "choose-backend-framework"   "$SKILLS_DIR/choose-backend-framework.md"
...
check "deploy-to-cloudflare"       "$SKILLS_DIR/deploy-to-cloudflare.md"
check "deploy-to-aws"              "$SKILLS_DIR/deploy-to-aws.md"
check "deploy-to-vps"              "$SKILLS_DIR/deploy-to-vps.md"
check "connect-supabase"           "$SKILLS_DIR/connect-supabase.md"
check "setup-better-auth"          "$SKILLS_DIR/setup-better-auth.md"
check "setup-inngest"              "$SKILLS_DIR/setup-inngest.md"
